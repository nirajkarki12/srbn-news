...
@section('title', 'Add a Ads')

@section('content-header', 'Add a Ads')
...
@section('breadcrumb')
    ...
    <li class="active"><i class="fa fa-plus"></i> Add a Ads</li>
@endsection
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border">
           <h3 class="box-title">Add a Ads</h3>
           <div class="box-tools pull-right">
              <a href="{{route('admin.adgroup')}}" class="btn btn-default pull-right">Adgroup</a>
           </div>
        </div>

        <form class="form-horizontal" action="{{route('admin.adgroup.store')}}" method="POST" role="form">
          {{ csrf_field() }}
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-9 pull-left">
                  <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}"  placeholder="Adgroup Title" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 pull-left">
                  <input type="number" class="form-control" id="show_after" name="show_after" value="{{ old('show_after') }}"  placeholder="Show after Number of Scroll" required>
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 pull-left">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" id="publish_date" name="publish_date" value="{{ old('publish_date') }}"  placeholder="Pick publish date" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 pull-left">
                  <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" id="expiry_date" name="expiry_date" value="{{ old('expiry_date') }}"  placeholder="Pick expiry date" required>
                  </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-md-12">
                  ...
                  <ul class="row text-center text-lg-left ckfinder-list">
                      @if(old('images') && is_array(old('images')) && count(old('images')) > 0)
