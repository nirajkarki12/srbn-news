...
@section('content-header', 'Add a Category')
@php
...
@section('breadcrumb')
    ...
    @if($parent)
      <li><a href="{{route('admin.category', ['parentSlug' => $parent['slug']])}}"><i class="fa fa-folder-o"></i> {{ $parent['name'] }}</a></li>
    @endif
    <li class="active"><i class="fa fa-plus"></i> Add a Category</li>
@endsection
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border">
           <h3 class="box-title">{{ $category['name']}} Category</h3>
           <div class="box-tools pull-right">
              
              <a href="{{route('admin.category', ['parentSlug' => $category['slug']])}}" class="btn btn-default pull-right">{{ $category['name']  ."'s Categories" }}</a>
           </div>
        </div>
