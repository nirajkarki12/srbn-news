...
$config['licenseName'] = env('CKEDITOR_LICENSE_NAME');
$config['licenseKey']  = env('CKEDITOR_LICENSE_KEY');
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => 'aiff,asf,avi,fla,flv,mid,mov,mp3,mpc,mpeg,mpg,ods,odt,rm,rmi,rmvb,rtf,vsd,wav,wma,wmv',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
